 ...
 * {@link HbaseTemplate}. Not often used, but a useful option to enhance
...
public interface HbaseOperations {
	...
	/**
	 * Executes the given action against the specified table handling resource
	 * management.
	 * <p>
	 * Application exceptions thrown by the action object get propagated to the
	 * caller (can only be unchecked). Allows for returning a result object
	 * (typically a domain object or collection of domain objects).
	 * 
	 * @param tableName
	 *            the target table
	 * @param action
	...
	/**
	 * Scans the target table, using the given family. The content is processed
	 * by the given action typically returning a domain object or collection of
	 * domain objects.
	 * 
	 * @param tableName
	 *            target table
	...
	/**
	 * Scans the target table, using the given column family and qualifier. The
	 * content is processed by the given action typically returning a domain
	 ...
	 * maximum control over the scanning process. The content is processed by
	 * the given action typically returning a domain object or collection of
	 * domain objects.
	 * 
	 * @param tableName
	 *            target table
	 ...
	 *            column qualifier
	 * @param data
	 *            the byte array of the data value to be put
	 */
	void put(String tableName, final String rowName, final String familyName, final String qualifier,
			final byte[] data);

	/**
	 * Puts multi value in to the given table.
	 * 
	 * @param tableName
	 *            target table
	 * @param rowName
	 ...
	 *            
	 */
	void put(String tableName, String rowName, String familyName, Map<String, byte[]> kvMap);
	 ...
	 * @param rowName
	 *            row name
	 * @param rowFamilyTable
	 *            
	 */
	void put(String tableName, final String rowName, final Table<String, String, byte[]> rowFamilyTable);
	 ...
	 *            row name
	 */
	void delete(String tableName, final String rowName);
	/**
	 * Deletes a single qualifier in the given table and family.
	 * 
	 * @param tableName
