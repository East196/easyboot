...
import com.github.east196.core.util.ThreadPoolUtil;
import com.github.east196.rap.ip.IpInfoUtil;
        ...
        try {
            ...
            if (StrUtil.isNotBlank(username)) {
                ...
                if(esRecord){
                    ...
                    ipInfoUtil.getInfo(request, Glue.mapToStringAll(request.getParameterMap()));
